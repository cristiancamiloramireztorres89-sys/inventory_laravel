...
{
    /**
     * Mostrar el panel de análisis de ganancias y márgenes de rentabilidad globales.
     */
    public function index(Request $request): View
    {
        $ventas = Venta::with(['usuario', 'cliente', 'detalles.producto.detalleCompras'])
