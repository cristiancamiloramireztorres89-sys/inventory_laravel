...
{
    /**
     * Listar todas las compras del sistema para el Administrador con trazabilidad completa.
     */
    public function index(Request $request): View
    {
        $compras = Compra::with(['usuario', 'proveedor', 'detalles.producto'])
        ...
        return view('admin.compras', compact('compras', 'totalCompras', 'totalInvertido', 'proveedores', 'productos'));
    }

    /**
     * Registrar una nueva compra/abastecimiento e incrementar existencias en el inventario.
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'id_producto.required'     => 'Debes seleccionar un producto a abastecer.',
            'cantidad.required'        => 'Ingresa la cantidad a comprar.',
            'cantidad.min'             => 'La cantidad mínima a comprar es 1 unidad.',
            'precio_unitario.required' => 'Ingresa el costo unitario de compra.',
        ...
        return redirect()->route('admin.compras')
            ->with('success', 'Compra registrada exitosamente y stock abastecido en el inventario.');
    }

    /**
     * Eliminar una compra y descontar las existencias correspondientes del inventario.
     */
    public function destroy(Compra $compra): RedirectResponse
    {
        DB::transaction(function () use ($compra) {
            // Descontar existencias añadidas
