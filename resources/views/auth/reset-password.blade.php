...
<head>
    ...
    <title>Nueva Contraseña | Inventory System</title>
    ...
    <div class="hidden lg:flex lg:w-1/2 xl:w-[52%] bg-slate-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div class="relative z-10 flex items-center gap-3">
            ...
            <div class="flex flex-col leading-none">
                ...
                <span class="text-[10px] text-slate-500 font-bold tracking-wider uppercase mt-0.5">Nueva Contraseña</span>
            </div>
        </div>
        ...
        <div class="relative z-10 space-y-6">
            ...
            <div class="space-y-3">
                <h2 class="text-3xl xl:text-4xl font-extrabold text-white leading-tight tracking-tight">
                    Crea tu nueva<br>
                    contraseña de<br>
                    <span class="text-slate-400">acceso seguro.</span>
                </h2>
                <p class="text-slate-400 text-sm leading-relaxed max-w-xs">
                    Elige una combinación segura de al menos 6 caracteres para proteger tu cuenta y la información del negocio.
                </p>
            </div>
            ...
            <ul class="space-y-2.5 text-sm text-slate-300 font-medium">
                <li class="flex items-center gap-2.5">
                    ...
                    Encriptación con algoritmos Bcrypt / Argon2
                </li>
                <li class="flex items-center gap-2.5">
                    <i class="bi bi-check-circle-fill text-emerald-400 text-xs"></i>
    ...
    <div class="w-full lg:w-1/2 xl:w-[48%] flex flex-col justify-between bg-white">
        ...
        <div class="flex items-center justify-between px-6 sm:px-10 py-5 border-b border-slate-100 lg:border-none">
            ...
            <a href="{{ route('login') }}" class="flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-slate-900 transition-colors ml-auto">
                <i class="bi bi-arrow-left text-xs"></i> Cancelar y volver al Login
            </a>
        </div>
        ...
        <div class="flex-1 flex items-center justify-center px-6 sm:px-12 py-8">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-7">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Restablecer Contraseña</h1>
                    <p class="text-slate-500 text-xs sm:text-sm mt-1.5">Define tu nueva clave de ingreso para continuar.</p>
                </div>
                ...
                <!-- Formulario -->
                <form action="{{ route('password.update') }}" method="POST" class="space-y-4" autocomplete="off" id="resetForm">
                    @csrf
